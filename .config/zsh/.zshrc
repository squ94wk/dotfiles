...
if [[ "$UPDATE" == "true" ]]; then
    ...
    sudo curl -fsSL "https://gist.github.com/squ94wk/23bda001326aa185de26d2a6b850a180/raw/b728181453aa698a7b646272c435c3bde71b8ce9/install_from_archive.sh" -o "/usr/local/bin/install_from_archive.sh" && sudo chmod +x "/usr/local/bin/install_from_archive.sh"
